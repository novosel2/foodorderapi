...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240312164808_MigrationBrother")]
    partial class MigrationBrother
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Domain.Entities.OrderedProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Core.Domain.Entities.OrderedProductTopping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("OrderedProductToppings");
                });
            ...
            modelBuilder.Entity("Core.Domain.Entities.OrderedProductTopping", b =>
                {
                    b.HasOne("Core.Domain.Entities.OrderedProduct", null)
                        .WithMany("OrderedProductToppings")
            ...
            modelBuilder.Entity("Core.Domain.Entities.OrderedProduct", b =>
                {
                    b.Navigation("OrderedProductToppings");
                });
